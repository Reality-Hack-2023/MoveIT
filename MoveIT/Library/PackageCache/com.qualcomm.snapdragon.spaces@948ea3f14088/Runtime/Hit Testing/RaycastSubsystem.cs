    ...
    public class RaycastSubsystem : XRRaycastSubsystem
    {
        ...
        private class SpacesProvider : Provider
        {
            ...
            public override void Start() {
                ...
                _planeDetectionFeature.TryCreatePlaneDetection(ID, PlaneDetectionMode.Horizontal | PlaneDetectionMode.Vertical, true);
            ...
            public override void Stop() {
                ...
                _planeDetectionFeature.TryDestroyPlaneDetection(ID);
            }

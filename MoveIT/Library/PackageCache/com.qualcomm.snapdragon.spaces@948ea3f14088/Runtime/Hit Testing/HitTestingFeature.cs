...
namespace Qualcomm.Snapdragon.Spaces
{
    ...
    internal sealed partial class HitTestingFeature : SpacesOpenXRFeature
    {
        ...
        public bool TryCreateRaycast(out ulong rayCastHandle) {
            ...
            XrRayCastTargetTypeQCOM[] targetTypes = { XrRayCastTargetTypeQCOM.XR_RAY_CAST_TARGET_TYPE_PLANE_QCOM };
            XrRayCastCreateInfoQCOM createInfo = new XrRayCastCreateInfoQCOM(XrRayTypeQCOM.XR_RAY_TYPE_PASSTHROUGH_QCOM, (uint)targetTypes.Length, targetTypes);
        ...
        public bool TryGetRayCastCollisions(ulong rayCastHandle, Vector3 origin, out List<XRRaycastHit> raycastHits) {
            ...
            IntPtr collisionsPtr = Marshal.AllocHGlobal(Marshal.SizeOf<XrRayCollisionQCOM>() * (int)collisionsCapacityInput);

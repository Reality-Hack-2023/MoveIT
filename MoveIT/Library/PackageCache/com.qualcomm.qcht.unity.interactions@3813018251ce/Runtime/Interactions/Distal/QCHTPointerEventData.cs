...
{
    public class QCHTPointerEventData : PointerEventData
    {
        public QCHTPointerEventData(EventSystem eventSystem)
            : base(eventSystem)
        {
        }
    ...
    public class QCHTDoublePointerEventData : BaseEventData
    {
        ...
        public QCHTPointerEventData leftData;
        public QCHTPointerEventData rightData;
    }
    ...
    public static class PointerEventDataExtensions
    {
        ...
        {
            return eventData is QCHTPointerEventData;
        }

        public static Ray GetRay(this PointerEventData pointerEventData)
        {
            var vrPointerEventData = pointerEventData as QCHTPointerEventData;
